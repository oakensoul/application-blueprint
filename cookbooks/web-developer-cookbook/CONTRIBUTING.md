# Contributing
So, you want to contribute to this cookbook? Welcome! Please read through the following
...
experience feature bloat or break existing users. Every new feature should fit
the Vision for the project. If you've got an idea for a new feature and you feel
it fits the vision, file an issue and we can discuss it.
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone git@github.com:<your-username>/<cookbook-repo-name>.git
   # Navigate to the newly cloned directory
   cd <cookbook-repo-name>
   # Assign the original repo to a remote called "upstream"
   git remote add upstream git@github.com:<your-username>/<cookbook-repo-name>.git
   ```
